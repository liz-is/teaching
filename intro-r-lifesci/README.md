...
0. First, download and install the software as described below. Run the code provided. Doing this will reveal a link to take the pre-workshop survey.
...
[Email me](http://stephenturner.us/email) if you have trouble getting set up.
